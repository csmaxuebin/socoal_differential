...
class OriginalWeightGraph_2:
    def __init__(self, fileName,epsilon):
        ...
        self.degreeThreshold=len(nx.degree_histogram(self.originalGraph))#度的阈值
        # self.degreeThreshold=4 #度的阈值
        self.triangleCountThreshold=len(triangle_count_histogram(self.originalGraph))#三角计数的阈值
    ...
    def getNodeFrequency(self):
        ...
        print(self.degreeThreshold,self.triangleCountThreshold)
